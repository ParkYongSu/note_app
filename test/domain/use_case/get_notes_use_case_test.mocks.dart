...
class MockNoteRepository extends _i1.Mock implements _i2.NoteRepository {
  ...
  @override
  _i3.Future<void> insert(_i4.Note? note) => (super.noSuchMethod(
        Invocation.method(
          #insert,
          [note],
        ),
  ...
  @override
  _i3.Future<void> update(_i4.Note? note) => (super.noSuchMethod(
        Invocation.method(
          #update,
          [note],
        ),
  ...
  @override
  _i3.Future<void> delete(_i4.Note? note) => (super.noSuchMethod(
        Invocation.method(
          #delete,
          [note],
        ),
